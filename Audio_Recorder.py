...
#Asks if the user would also like to make a TXT file for debugging.
print("Make TXT file from recording for debug? (Y/N)")
while True:
    if keyboard.is_pressed('y'):
        write_frames_to_txt_file()
        break  
    elif keyboard.is_pressed('n'): 
        break
                                   
write_frames_to_wav_file()
